...
- `data/discovery/`: maintained Tier 1 and Tier 2 official-page and manifest
  targets for reproducible candidate discovery.
...
to the run summary. It never adds or promotes catalogue records automatically.
...
to the appropriate target file so subsequent runs cover them.
