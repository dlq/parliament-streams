.PHONY: verify test coverage json-check site-data site-data-check compile format format-check lint healthcheck site
...
verify: json-check site-data-check format-check lint compile coverage
